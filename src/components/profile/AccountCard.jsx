...
export default function AccountCard({ account, accent = 'emerald' }) {
  ...
  return (
    <div className="group relative p-6 rounded-2xl border border-slate-200 bg-white hover:border-navy-300 hover:shadow-[0_20px_50px_-20px_rgba(10,37,64,0.25)] transition-all">
      <div
      ...
      <div className="relative flex items-start justify-between gap-4">
        <div>
          ...
          <div className="font-semibold text-navy-800 mt-1 leading-snug">
            {account.name}
          </div>
        ...
        <a
          href="#"
          className="p-2 rounded-full bg-slate-100 text-slate-500 group-hover:bg-navy-800 group-hover:text-white transition-colors"
